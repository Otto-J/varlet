...
var id = ne({
  ...
  setup(e) {
    ...
    return le(() => e.disabled, w), sn(k), Ja(M), br(M), ka(window, "scroll", y), {
      n: Ly,
      classes: Ry,
      resize: w,
      stickyEl: n,
  ...
  setup(e, n) {
    ...
    return le([l, () => e.isInner], (w, k) => {
      ...
      if (t.value = [], k && !M) {
        var {
          hour: P
        } = tn(k), D = pn.filter((N) => L(N) > P), S = en.filter((N) => L(N) > P);
        t.value = [...D, ...S];
      }
      if (!k && M) {
        var {
      ...
      if (k && M) {
        var {
          ...
          hour: g
        } = tn(M), C = pn.filter((N) => L(N) < g || L(N) > V), H = en.filter((N) => L(N) < g || L(N) > V);
        t.value = [...C, ...H];
      }
      if (b != null && b.hours) {
        var {
