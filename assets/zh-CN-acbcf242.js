...
`)])],-1),I={class:"card"},A={id:"自定义图标库"},D=s("p",null,[a("首先您需要设置您自己的字体，并引入到您的项目。 这里假设扩展一个名为 "),s("code",null,"my-icons"),a(" 的字体。")],-1),F=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"/* 设置字体 */"),a(`
...
`)])],-1),M=s("p",null,[a("到这里你就成功的扩展了自己的图标库，"),s("code",null,"my-icon"),a(" 就是你的字体 "),s("code",null,"命名空间(namespace)"),a("，您可以这样使用。")],-1),T=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
...
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),Z=s("h2",null,"API",-1),q={class:"card"},G={id:"属性"},H=o("<table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td><code>name</code></td><td>图标名称</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>size</code></td><td>尺寸</td><td><em>string | number</em></td><td><code>-</code></td></tr><tr><td><code>color</code></td><td>图标颜色, 只适用于字体图标</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>namespace</code></td><td>图标的命名空间, 可扩展自定义图标库</td><td><em>string</em></td><td><code>var-icon</code></td></tr><tr><td><code>animation-class</code></td><td>过渡动画类名</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>transition</code></td><td>过渡动画时间（ms）</td><td><em>string | number</em></td><td><code>0</code></td></tr></tbody></table>",1),J={class:"card"},K={id:"事件"},L=s("table",null,[s("thead",null,[s("tr",null,[s("th",null,"事件名"),s("th",null,"说明"),s("th",null,"参数")])]),s("tbody",null,[s("tr",null,[s("td",null,[s("code",null,"click")]),s("td",null,"点击图标时触发"),s("td",null,[s("code",null,"event: Event")])])])],-1),O={class:"card"},Q={id:"样式变量"},R=o('<p>以下为组件使用的 css 变量，可以使用 <a href="#/zh-CN/style-provider">StyleProvider 组件</a> 进行样式定制。</p><table><thead><tr><th>变量名</th><th>默认值</th></tr></thead><tbody><tr><td><code>--icon-size</code></td><td><code>20px</code></td></tr></tbody></table>',2);function U(W,X,Y,ss,as,ls){const t=e("router-link"),c=e("var-site-code-example");return h(),d("div",i,[j,s("div",m,[s("h3",_,[l(t,{to:"#介绍"},{default:n(()=>[a("#")]),_:1}),a("介绍")]),u]),s("div",g,[s("h3",f,[l(t,{to:"#图标尺寸"},{default:n(()=>[a("#")]),_:1}),a("图标尺寸")]),l(c,null,{default:n(()=>[v]),_:1})]),s("div",y,[s("h3",b,[l(t,{to:"#图标颜色"},{default:n(()=>[a("#")]),_:1}),a("图标颜色")]),l(c,null,{default:n(()=>[k]),_:1})]),s("div",x,[s("h3",z,[l(t,{to:"#使用图片"},{default:n(()=>[a("#")]),_:1}),a("使用图片")]),w,l(c,null,{default:n(()=>[N]),_:1})]),s("div",C,[s("h3",S,[l(t,{to:"#注册事件"},{default:n(()=>[a("#")]),_:1}),a("注册事件")]),l(c,null,{default:n(()=>[V]),_:1})]),s("div",$,[s("h3",B,[l(t,{to:"#图标切换动画"},{default:n(()=>[a("#")]),_:1}),a("图标切换动画")]),P,l(c,null,{default:n(()=>[E]),_:1})]),s("div",I,[s("h3",A,[l(t,{to:"#自定义图标库"},{default:n(()=>[a("#")]),_:1}),a("自定义图标库")]),D,l(c,{"playground-ignore":""},{default:n(()=>[F]),_:1}),M,l(c,{"playground-ignore":""},{default:n(()=>[T]),_:1})]),Z,s("div",q,[s("h3",G,[l(t,{to:"#属性"},{default:n(()=>[a("#")]),_:1}),a("属性")]),H]),s("div",J,[s("h3",K,[l(t,{to:"#事件"},{default:n(()=>[a("#")]),_:1}),a("事件")]),L]),s("div",O,[s("h3",Q,[l(t,{to:"#样式变量"},{default:n(()=>[a("#")]),_:1}),a("样式变量")]),R])])}const ts=r(p,[["render",U]]);export{ts as default};
