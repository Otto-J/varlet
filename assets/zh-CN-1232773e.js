import{_ as n,p as c,f as d,h,M as a,q as l,S as e,P as s,aq as o}from"./vue-router.esm-bundler-23fbfb7d.js";const p={components:{}},r={class:"varlet-site-doc"},i=a("h1",null,"粘性布局",-1),j=a("div",{class:"card"},[a("h3",null,"介绍"),a("p",null,[s("粘性布局默认使用监听容器滚动事件的 "),a("code",null,"scroll"),s(" 模式，如有需要可以切换成基于 "),a("code",null,"css sticky"),s(" 的模式来提升性能。")])],-1),m={class:"card"},b=a("h3",null,"基本使用",-1),u=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
