...
`)])],-1);function C($,B,D,P,S,T){const e=c("router-link"),n=c("var-site-code-example");return p(),d("div",h,[_,s("div",u,[s("h3",m,[o(e,{to:"#介绍"},{default:a(()=>[t("#")]),_:1}),t("介绍")]),j]),s("div",v,[s("h3",x,[o(e,{to:"#移动端适配"},{default:a(()=>[t("#")]),_:1}),t("移动端适配")]),f,o(n,{"playground-ignore":""},{default:a(()=>[g]),_:1}),o(n,{"playground-ignore":""},{default:a(()=>[b]),_:1})]),s("div",w,[s("h3",y,[o(e,{to:"#桌面端适配"},{default:a(()=>[t("#")]),_:1}),t("桌面端适配")]),k,o(n,{"playground-ignore":""},{default:a(()=>[N]),_:1}),o(n,{"playground-ignore":""},{default:a(()=>[V]),_:1})])])}const q=l(i,[["render",C]]);export{q as default};
