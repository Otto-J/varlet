...
`)])],-1),A=s("p",null,"或",-1),N=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[n("<"),s("span",{class:"hljs-name"},"script"),n(),s("span",{class:"hljs-attr"},"setup"),n(">")]),s("span",{class:"javascript"},[n(`
...
`),s("span",{class:"hljs-tag"},[n("</"),s("span",{class:"hljs-name"},"template"),n(">")]),n(`
`)])],-1),$={class:"card"},q={id:"手动引入和自动引入对比"},S=s("h4",null,"手动引入",-1),E=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[n("<"),s("span",{class:"hljs-name"},"script"),n(),s("span",{class:"hljs-attr"},"setup"),n(">")]),s("span",{class:"javascript"},[n(`
...
`),s("span",{class:"hljs-tag"},[n("<"),s("span",{class:"hljs-name"},"template"),n(">")]),n(`
  `),s("span",{class:"hljs-tag"},[n("<"),s("span",{class:"hljs-name"},"var-button"),n(" @"),s("span",{class:"hljs-attr"},"click"),n("="),s("span",{class:"hljs-string"},'"handleClick"'),n(">")]),n("说你好"),s("span",{class:"hljs-tag"},[n("</"),s("span",{class:"hljs-name"},"var-button"),n(">")]),n(`
`),s("span",{class:"hljs-tag"},[n("</"),s("span",{class:"hljs-name"},"template"),n(">")]),n(`
`)])],-1),L={class:"card"},O={id:"文件路径注意"},P=s("p",null,[n("在 "),s("code",null,"@varlet/ui@2.7.0"),n(" 及其之后的版本，我们推荐使用如下省略后缀名的文件引入方式，以兼容 "),s("code",null,"js"),n(" 和 "),s("code",null,"mjs")],-1),W=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"import"),n(),s("span",{class:"hljs-string"},"'@varlet/ui/es/style'"),n(`
`)])],-1);function F(G,H,J,K,M,Q){const e=o("router-link"),t=o("var-site-code-example");return p(),r("div",h,[u,s("div",d,[s("h3",j,[a(e,{to:"#介绍"},{default:l(()=>[n("#")]),_:1}),n("介绍")]),m]),s("div",_,[s("h3",g,[a(e,{to:"#自动引入"},{default:l(()=>[n("#")]),_:1}),n("自动引入")]),v,y,a(t,{"playground-ignore":""},{default:l(()=>[k]),_:1}),f,a(t,{"playground-ignore":""},{default:l(()=>[w]),_:1}),b,a(t,{"playground-ignore":""},{default:l(()=>[I]),_:1}),V,x,a(t,{"playground-ignore":""},{default:l(()=>[C]),_:1})]),s("div",B,[s("h3",R,[a(e,{to:"#手动引入"},{default:l(()=>[n("#")]),_:1}),n("手动引入")]),U,a(t,{"playground-ignore":""},{default:l(()=>[D]),_:1}),A,a(t,{"playground-ignore":""},{default:l(()=>[N]),_:1})]),s("div",$,[s("h3",q,[a(e,{to:"#手动引入和自动引入对比"},{default:l(()=>[n("#")]),_:1}),n("手动引入和自动引入对比")]),S,a(t,{"playground-ignore":""},{default:l(()=>[E]),_:1}),T,a(t,{"playground-ignore":""},{default:l(()=>[z]),_:1})]),s("div",L,[s("h3",O,[a(e,{to:"#文件路径注意"},{default:l(()=>[n("#")]),_:1}),n("文件路径注意")]),P,a(t,{"playground-ignore":""},{default:l(()=>[W]),_:1})])])}const Y=c(i,[["render",F]]);export{Y as default};
