import{_ as p,p as c,f as o,h as r,M as s,q as n,S as l,P as a}from"./vue-router-40fc6ea4.js";const h={components:{}},d={class:"varlet-site-doc"},i=s("h1",null,"快速开始",-1),_={class:"card"},u={id:"介绍"},j=s("p",null,"这里为您介绍常见开发模式下接入组件库的最基本方式。",-1),m={class:"card"},v={id:"安装"},g=s("h4",null,"CDN",-1),f=s("p",null,[s("code",null,"varlet.js"),a(" 包含组件库的所有样式和逻辑, 引入即可。")],-1),y=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"div"),a(),s("span",{class:"hljs-attr"},"id"),a("="),s("span",{class:"hljs-string"},'"app"'),a(">")]),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"div"),a(">")]),a(`
...
pnpm add @varlet/ui
`)])],-1),V=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"import"),a(" App "),s("span",{class:"hljs-keyword"},"from"),a(),s("span",{class:"hljs-string"},"'./App.vue'"),a(`
