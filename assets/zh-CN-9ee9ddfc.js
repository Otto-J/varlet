...
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),S={class:"card"},C={id:"注册事件"},V=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"script"),a(),s("span",{class:"hljs-attr"},"setup"),a(">")]),s("span",{class:"javascript"},[a(`
...
`),s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
  ...
  />`)]),a(`
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),$={class:"card"},B={id:"图标切换动画"},P=s("p",null,[a("当设置了 "),s("code",null,"transition(ms)"),a(" 并通过图标的 "),s("code",null,"name"),a(" 切换图标时，可以触发切换动画。")],-1),E=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"script"),a(),s("span",{class:"hljs-attr"},"setup"),a(">")]),s("span",{class:"javascript"},[a(`
...
`)])],-1),I={class:"card"},M={id:"自定义图标库"},q=s("p",null,[a("首先您需要设置您自己的字体，并引入到您的项目。 这里假设扩展一个名为 "),s("code",null,"my-icons"),a(" 的字体。")],-1),A=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"/* 设置字体 */"),a(`
...
`)])],-1),D=s("p",null,[a("到这里你就成功的扩展了自己的图标库，"),s("code",null,"my-icon"),a(" 就是你的字体 "),s("code",null,"命名空间(namespace)"),a("，您可以这样使用。")],-1),F=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
...
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),T=s("h2",null,"API",-1),G={class:"card"},H={id:"属性"},J=o("<table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td><code>name</code></td><td>图标名称</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>size</code></td><td>尺寸</td><td><em>string | number</em></td><td><code>-</code></td></tr><tr><td><code>color</code></td><td>图标颜色, 只适用于字体图标</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>namespace</code></td><td>图标的命名空间, 可扩展自定义图标库</td><td><em>string</em></td><td><code>var-icon</code></td></tr><tr><td><code>animation-class</code></td><td>过渡动画类名</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>transition</code></td><td>过渡动画时间（ms）</td><td><em>string | number</em></td><td><code>0</code></td></tr></tbody></table>",1),K={class:"card"},L={id:"事件"},O=s("table",null,[s("thead",null,[s("tr",null,[s("th",null,"事件名"),s("th",null,"说明"),s("th",null,"参数")])]),s("tbody",null,[s("tr",null,[s("td",null,[s("code",null,"click")]),s("td",null,"点击图标时触发"),s("td",null,[s("code",null,"event: Event")])])])],-1),Q={class:"card"},R={id:"样式变量"},U=o('<p>以下为组件使用的 css 变量，可以使用 <a href="#/zh-CN/style-provider">StyleProvider 组件</a> 进行样式定制。</p><table><thead><tr><th>变量名</th><th>默认值</th></tr></thead><tbody><tr><td><code>--icon-size</code></td><td><code>20px</code></td></tr></tbody></table>',2);function W(X,Y,Z,ss,as,ls){const t=e("router-link"),c=e("var-site-code-example");return h(),d("div",i,[j,s("div",m,[s("h3",_,[l(t,{to:"#介绍"},{default:n(()=>[a("#")]),_:1}),a("介绍")]),u]),s("div",g,[s("h3",f,[l(t,{to:"#图标尺寸"},{default:n(()=>[a("#")]),_:1}),a("图标尺寸")]),l(c,null,{default:n(()=>[v]),_:1})]),s("div",y,[s("h3",b,[l(t,{to:"#图标颜色"},{default:n(()=>[a("#")]),_:1}),a("图标颜色")]),l(c,null,{default:n(()=>[k]),_:1})]),s("div",x,[s("h3",z,[l(t,{to:"#使用图片"},{default:n(()=>[a("#")]),_:1}),a("使用图片")]),w,l(c,null,{default:n(()=>[N]),_:1})]),s("div",S,[s("h3",C,[l(t,{to:"#注册事件"},{default:n(()=>[a("#")]),_:1}),a("注册事件")]),l(c,null,{default:n(()=>[V]),_:1})]),s("div",$,[s("h3",B,[l(t,{to:"#图标切换动画"},{default:n(()=>[a("#")]),_:1}),a("图标切换动画")]),P,l(c,null,{default:n(()=>[E]),_:1})]),s("div",I,[s("h3",M,[l(t,{to:"#自定义图标库"},{default:n(()=>[a("#")]),_:1}),a("自定义图标库")]),q,l(c,{"playground-ignore":""},{default:n(()=>[A]),_:1}),D,l(c,{"playground-ignore":""},{default:n(()=>[F]),_:1})]),T,s("div",G,[s("h3",H,[l(t,{to:"#属性"},{default:n(()=>[a("#")]),_:1}),a("属性")]),J]),s("div",K,[s("h3",L,[l(t,{to:"#事件"},{default:n(()=>[a("#")]),_:1}),a("事件")]),O]),s("div",Q,[s("h3",R,[l(t,{to:"#样式变量"},{default:n(()=>[a("#")]),_:1}),a("样式变量")]),U])])}const ts=r(p,[["render",W]]);export{ts as default};
