...
`)])],-1),b={class:"card"},y={id:"Function Binding"},k=a("p",null,"The function is triggered when the pointer hovers and leaves, and carries the current hover state.",-1),w=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
...
`)]),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"style"),s(">")]),s(`
`)])],-1),x={class:"card"},B={id:"Selectively enable for different devices"},S=a("p",null,[s("Considering the differences in "),a("code",null,"hover"),s(" effects on different platforms, the hover command can only be enabled on specific platforms.")],-1),H=a("h4",null,"Only enabled on desktop",-1),V=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-paper"),s(),a("span",{class:"hljs-attr"},"v-hover:desktop"),s("="),a("span",{class:"hljs-string"},`"{ color: '#fff' }"`),s('">')]),s("HOVER"),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-paper"),s(">")]),s(`
`)])],-1),O=a("h4",null,"Only enabled on mobile",-1),E=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-paper"),s(),a("span",{class:"hljs-attr"},"v-hover:mobile"),s("="),a("span",{class:"hljs-string"},`"{ color: '#fff' }"`),s('">')]),s("HOVER"),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-paper"),s(">")]),s(`
`)])],-1);function $(R,Y,C,F,I,N){const e=c("router-link"),t=c("var-site-code-example");return p(),o("div",i,[j,a("div",d,[a("h3",u,[n(e,{to:"#Intro"},{default:l(()=>[s("#")]),_:1}),s("Intro")]),g]),a("div",m,[a("h3",_,[n(e,{to:"#Style Binding"},{default:l(()=>[s("#")]),_:1}),s("Style Binding")]),f,n(t,null,{default:l(()=>[v]),_:1})]),a("div",b,[a("h3",y,[n(e,{to:"#Function Binding"},{default:l(()=>[s("#")]),_:1}),s("Function Binding")]),k,n(t,null,{default:l(()=>[w]),_:1})]),a("div",x,[a("h3",B,[n(e,{to:"#Selectively enable for different devices"},{default:l(()=>[s("#")]),_:1}),s("Selectively enable for different devices")]),S,H,n(t,{"playground-ignore":""},{default:l(()=>[V]),_:1}),O,n(t,{"playground-ignore":""},{default:l(()=>[E]),_:1})])])}const q=r(h,[["render",$]]);export{q as default};
