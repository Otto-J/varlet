...
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),C=p('<h2>API</h2><div class="card"><h3>Props</h3><table><thead><tr><th>Prop</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td><code>style-vars</code></td><td>CSS variables</td><td><em>Record&lt;string, string&gt;</em></td><td><code>{}</code></td></tr><tr><td><code>tag</code></td><td>Tag name</td><td><em>string</em></td><td><code>div</code></td></tr></tbody></table></div><div class="card"><h3>Slots</h3><table><thead><tr><th>Name</th><th>Description</th><th>SlotProps</th></tr></thead><tbody><tr><td><code>default</code></td><td>Component content</td><td><code>-</code></td></tr></tbody></table></div>',3);function z(V,P,N,B,R,$){const l=c("var-site-code-example");return r(),o("div",i,[d,j,s("div",u,[m,b,t(l,{"playground-ignore":""},{default:n(()=>[g]),_:1})]),v,s("div",y,[_,f,t(l,null,{default:n(()=>[S]),_:1})]),s("div",k,[w,x,t(l,null,{default:n(()=>[T]),_:1})]),C])}const D=e(h,[["render",z]]);export{D as default};
