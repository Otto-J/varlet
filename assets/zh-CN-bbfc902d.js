...
`)]),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"style"),s(">")]),s(`
`)])],-1),N={class:"card"},R={id:"对齐"},V=a("p",null,[s("布局组件默认使用 "),a("code",null,"flex"),s(" 布局，通过 "),a("code",null,"<var-row/>"),s("的 "),a("code",null,"justify"),s(" 和 "),a("code",null,"align"),s(" 属性设置主轴和交叉轴的对齐方式。")],-1),$=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`)]),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"style"),s(">")]),s(`
`)])],-1),P={class:"card"},S={id:"响应式布局"},O=a("h4",null,"基本用法",-1),q={class:"varlet-component-preview"},z=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
