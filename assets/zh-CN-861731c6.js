import{_ as o,p as c,f as h,h as p,M as t,q as a,S as l,P as s,aq as d}from"./vue-router-609def63.js";const i={components:{}},r={class:"varlet-site-doc"},_=t("h1",null,"文本省略",-1),j={class:"card"},m={id:"介绍"},g=t("p",null,"主要用于省略单行文字和多行文字。",-1),u={class:"card"},f={id:"单行省略"},v=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
