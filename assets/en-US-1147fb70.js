...
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),v={class:"card"},y={id:"Custom Format"},S=t("p",null,[s("Use "),t("code",null,"format"),s(" to set time text.")],-1),k=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
`),t("span",{class:"hljs-keyword"},"import"),s(" { ref } "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'vue'"),s(`
...
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),x={class:"card"},D={id:"Show Millisecond"},M=t("p",null,[s("Use "),t("code",null,"S"),s(" text to show millisecond.")],-1),C=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
`),t("span",{class:"hljs-keyword"},"import"),s(" { ref } "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'vue'"),s(`
...
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),T={class:"card"},U={id:"Custom Style"},H=t("p",null,[s("Use "),t("code",null,"slot"),s(" to set custom countdown style.")],-1),P=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`)])],-1),E={class:"card"},R={id:"Manual Control"},$=t("p",null,[s("Use "),t("code",null,"ref"),s(" to get countdown instance, you can call the "),t("code",null,"start"),s(", "),t("code",null,"pause"),s(", and "),t("code",null,"reset"),s(" methods.")],-1),B=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
`),t("span",{class:"hljs-keyword"},"import"),s(" { ref } "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'vue'"),s(`
...
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),N=t("h2",null,"API",-1),F={class:"card"},A={id:"Props"},I=c("<table><thead><tr><th>Prop</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td><code>time</code></td><td>Total time(ms)</td><td><em>string | number</em></td><td><code>0</code></td></tr><tr><td><code>format</code></td><td>Time format</td><td><em>string</em></td><td><code>HH : mm : ss</code></td></tr><tr><td><code>auto-start</code></td><td>Whether to auto start count down</td><td><em>boolean</em></td><td><code>true</code></td></tr></tbody></table>",1),V={class:"card"},q={id:"Available formats"},z=c("<table><thead><tr><th>Format</th><th>Description</th></tr></thead><tbody><tr><td><code>DD</code></td><td>Day</td></tr><tr><td><code>HH</code></td><td>Hour</td></tr><tr><td><code>mm</code></td><td>Minute</td></tr><tr><td><code>ss</code></td><td>Second</td></tr><tr><td><code>S</code></td><td>Millisecond, 1-digit</td></tr><tr><td><code>SS</code></td><td>Millisecond, 2-digit</td></tr><tr><td><code>SSS</code></td><td>Millisecond, 3-digit</td></tr></tbody></table>",1),W={class:"card"},G={id:"Events"},J=c("<table><thead><tr><th>Event</th><th>Description</th><th>arguments</th></tr></thead><tbody><tr><td><code>end</code></td><td>Emitted after countdown ended</td><td><code>-</code></td></tr><tr><td><code>change</code></td><td>Emitted after countdown changed</td><td><code>timeData: TimeData</code></td></tr></tbody></table>",1),K={class:"card"},L={id:"Slots"},O=t("table",null,[t("thead",null,[t("tr",null,[t("th",null,"Name"),t("th",null,"Description"),t("th",null,"SlotProps")])]),t("tbody",null,[t("tr",null,[t("td",null,[t("code",null,"default")]),t("td",null,"Custom content"),t("td",null,[t("code",null,"timeData: TimeData")])])])],-1),Q={class:"card"},X={id:"TimeData Structure"},Y=c("<table><thead><tr><th>Name</th><th>Description</th><th>Type</th></tr></thead><tbody><tr><td><code>days</code></td><td>Remain days</td><td><code>number</code></td></tr><tr><td><code>hours</code></td><td>Remain hours</td><td><code>number</code></td></tr><tr><td><code>minutes</code></td><td>Remain minutes</td><td><code>number</code></td></tr><tr><td><code>seconds</code></td><td>Remain seconds</td><td><code>number</code></td></tr><tr><td><code>milliseconds</code></td><td>Remain milliseconds</td><td><code>number</code></td></tr></tbody></table>",1),Z={class:"card"},ss={id:"Methods"},ts=c("<p>Use ref to get CountDown instance and call instance methods.</p><table><thead><tr><th>Method</th><th>Description</th><th>arguments</th><th>Return</th></tr></thead><tbody><tr><td><code>start</code></td><td>Start countdown</td><td><code>-</code></td><td><code>-</code></td></tr><tr><td><code>pause</code></td><td>Pause countdown</td><td><code>-</code></td><td><code>-</code></td></tr><tr><td><code>reset</code></td><td>Reset countdown</td><td><code>-</code></td><td><code>-</code></td></tr></tbody></table>",2);function as(ns,ls,es,cs,os,ds){const l=o("router-link"),e=o("var-site-code-example");return h(),r("div",i,[j,t("div",m,[t("h3",u,[a(l,{to:"#Intro"},{default:n(()=>[s("#")]),_:1}),s("Intro")]),_]),t("div",g,[t("h3",b,[a(l,{to:"#Basic Usage"},{default:n(()=>[s("#")]),_:1}),s("Basic Usage")]),f,a(e,null,{default:n(()=>[w]),_:1})]),t("div",v,[t("h3",y,[a(l,{to:"#Custom Format"},{default:n(()=>[s("#")]),_:1}),s("Custom Format")]),S,a(e,null,{default:n(()=>[k]),_:1})]),t("div",x,[t("h3",D,[a(l,{to:"#Show Millisecond"},{default:n(()=>[s("#")]),_:1}),s("Show Millisecond")]),M,a(e,null,{default:n(()=>[C]),_:1})]),t("div",T,[t("h3",U,[a(l,{to:"#Custom Style"},{default:n(()=>[s("#")]),_:1}),s("Custom Style")]),H,a(e,null,{default:n(()=>[P]),_:1})]),t("div",E,[t("h3",R,[a(l,{to:"#Manual Control"},{default:n(()=>[s("#")]),_:1}),s("Manual Control")]),$,a(e,null,{default:n(()=>[B]),_:1})]),N,t("div",F,[t("h3",A,[a(l,{to:"#Props"},{default:n(()=>[s("#")]),_:1}),s("Props")]),I]),t("div",V,[t("h3",q,[a(l,{to:"#Available formats"},{default:n(()=>[s("#")]),_:1}),s("Available formats")]),z]),t("div",W,[t("h3",G,[a(l,{to:"#Events"},{default:n(()=>[s("#")]),_:1}),s("Events")]),J]),t("div",K,[t("h3",L,[a(l,{to:"#Slots"},{default:n(()=>[s("#")]),_:1}),s("Slots")]),O]),t("div",Q,[t("h3",X,[a(l,{to:"#TimeData Structure"},{default:n(()=>[s("#")]),_:1}),s("TimeData Structure")]),Y]),t("div",Z,[t("h3",ss,[a(l,{to:"#Methods"},{default:n(()=>[s("#")]),_:1}),s("Methods")]),ts])])}const rs=d(p,[["render",as]]);export{rs as default};
