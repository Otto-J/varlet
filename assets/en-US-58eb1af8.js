import{_ as c,p as o,f as r,h,M as s,q as e,S as l,P as a}from"./vue-router-1c193d5c.js";const p={components:{}},i={class:"varlet-site-doc"},d=s("h1",null,"Dark Mode",-1),m={class:"card"},_={id:"Intro"},u=s("p",null,"The first party of the component library provides the theme of dark mode. The advantage of dark mode is that it has higher readability in low light environments.",-1),j={class:"card"},g={id:"Toggle Theme"},b=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"script"),a(),s("span",{class:"hljs-attr"},"setup"),a(">")]),s("span",{class:"javascript"},[a(`
...
`)])],-1);function f(k,y,x,w,I,S){const n=o("router-link"),t=o("var-site-code-example");return r(),h("div",i,[d,s("div",m,[s("h3",_,[e(n,{to:"#Intro"},{default:l(()=>[a("#")]),_:1}),a("Intro")]),u]),s("div",j,[s("h3",g,[e(n,{to:"#Toggle Theme"},{default:l(()=>[a("#")]),_:1}),a("Toggle Theme")]),e(t,{"playground-ignore":""},{default:l(()=>[b]),_:1}),v,e(t,{"playground-ignore":""},{default:l(()=>[T]),_:1})])])}const B=c(p,[["render",f]]);export{B as default};
