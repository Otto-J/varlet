import{_ as c,p as d,f as r,h as p,M as a,q as t,S as n,P as s,aq as e}from"./vue-router.esm-bundler-6a15ebdc.js";const o={components:{}},h={class:"varlet-site-doc"},j=a("h1",null,"滑块",-1),i=a("div",{class:"card"},[a("h3",null,"介绍"),a("p",null,"用于在给定范围内取值。")],-1),m={class:"card"},u=a("h3",null,"基本使用",-1),g=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
