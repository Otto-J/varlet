import{_ as d,p as c,f as n,h as o,M as t,q as l,S as e,aq as r,P as s}from"./vue-router.esm-bundler-2ca71151.js";const h={components:{}},p={class:"varlet-site-doc"},i=t("h1",null,"单元格",-1),j=t("div",{class:"card"},[t("h3",null,"介绍"),t("p",null,"单元格为列表中的单个展示项。")],-1),m={class:"card"},g=t("h3",null,"基本使用",-1),_=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
