import{_ as o,p as c,f as r,h as i,M as t,q as a,S as n,P as s,aq as p}from"./vue-router-6d86b99d.js";const d={components:{}},h={class:"varlet-site-doc"},j=t("h1",null,"Lazy",-1),g={class:"card"},u={id:"Intro"},m=t("p",null,"Load when the image is visible.",-1),_={class:"card"},b={id:"Basic Use"},y=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`)])],-1),T=t("h2",null,"API",-1),q={class:"card"},N={id:"Plugin Options"},O=p("<table><thead><tr><th>Option</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td><code>loading</code></td><td>Loading images, if possible, select images that load quickly</td><td><em>string</em></td><td><code>Pixel transparent picture</code></td></tr><tr><td><code>error</code></td><td>Load failed to display the picture</td><td><em>string</em></td><td><code>Pixel transparent picture</code></td></tr><tr><td><code>attempt</code></td><td>The number of times a load failed to reload</td><td><em>number</em></td><td><code>3</code></td></tr><tr><td><code>throttleWait</code></td><td>throttle wait time, The higher the value, the lower the trigger frequency</td><td><em>number</em></td><td><code>300</code></td></tr><tr><td><code>events</code></td><td>A list of events that trigger visibility detection registration</td><td><em>string[]</em></td><td><code>[&#39;scroll&#39;...]</code></td></tr><tr><td><code>filter</code></td><td>Attribute interceptor function</td><td><em>(lazy: Lazy) =&gt; void</em></td><td><code>() =&gt; void</code></td></tr></tbody></table>",1);function S(U,V,$,C,D,W){const e=c("router-link"),l=c("var-site-code-example");return r(),i("div",h,[j,t("div",g,[t("h3",u,[a(e,{to:"#Intro"},{default:n(()=>[s("#")]),_:1}),s("Intro")]),m]),t("div",_,[t("h3",b,[a(e,{to:"#Basic Use"},{default:n(()=>[s("#")]),_:1}),s("Basic Use")]),a(l,null,{default:n(()=>[y]),_:1})]),t("div",v,[t("h3",f,[a(e,{to:"#Background Image Lazy Load"},{default:n(()=>[s("#")]),_:1}),s("Background Image Lazy Load")]),a(l,null,{default:n(()=>[x]),_:1})]),t("div",z,[t("h3",k,[a(e,{to:"#Inline Attributes"},{default:n(()=>[s("#")]),_:1}),s("Inline Attributes")]),w,a(l,null,{default:n(()=>[L]),_:1})]),t("div",I,[t("h3",P,[a(e,{to:"#Plugin"},{default:n(()=>[s("#")]),_:1}),s("Plugin")]),A,a(l,{"playground-ignore":""},{default:n(()=>[B]),_:1})]),T,t("div",q,[t("h3",N,[a(e,{to:"#Plugin Options"},{default:n(()=>[s("#")]),_:1}),s("Plugin Options")]),O])])}const M=o(d,[["render",S]]);export{M as default};
