  ...
  |-- pages
    ...
    |-- changelog
      |-- locale
        ...
        |-- en-US.ts
      |-- index.vue
`)],-1),z=t("p",null,"生成的路由如下：",-1),U=t("pre",{class:"hljs"},[t("code",null,`/zh-CN/sponsor
/en-US/contributor
/zh-CN/changelog
/en-US/changelog
`)],-1),$={class:"card"},B={id:"命令相关"},E=t("h4",null,"启动开发服务器",-1),L=t("pre",{class:"hljs"},[t("code",null,[e(`varlet-cli dev
`),t("span",{class:"hljs-meta"},"#"),t("span",{class:"bash"}," force mode"),e(`
varlet-cli dev -f
`),t("span",{class:"hljs-meta"},"#"),t("span",{class:"bash"}," draft mode"),e(`
varlet-cli dev -d
`)])],-1),O=t("h4",null,"构建文档站点",-1),P=t("pre",{class:"hljs"},[t("code",null,`varlet-cli build
`)],-1),q=t("h4",null,"预览文档站点",-1),A=t("pre",{class:"hljs"},[t("code",null,`varlet-cli preview
`)],-1),I=t("h4",null,"构建组件库",-1),D=t("pre",{class:"hljs"},[t("code",null,`varlet-cli compile
`)],-1),F=t("h4",null,"启动 VSCode 插件开发环境",-1),G=t("pre",{class:"hljs"},[t("code",null,`varlet-cli dev:extension
`)],-1),H=t("h4",null,"构建 VSCode 插件",-1),J=t("pre",{class:"hljs"},[t("code",null,`varlet-cli build:extension
`)],-1),K=t("h4",null,"打包字体图标",-1),Q=t("pre",{class:"hljs"},[t("code",null,`varlet-cli build:icons
`)],-1),W=t("h4",null,"执行所有的单元测试",-1),X=t("pre",{class:"hljs"},[t("code",null,`varlet-cli test
`)],-1),Y=t("h4",null,"以 watch 模式执行单元测试",-1),Z=t("pre",{class:"hljs"},[t("code",null,`varlet-cli test -w
or
varlet-cli test -wa
`)],-1),tt=t("h4",null,"检查代码",-1),et=t("pre",{class:"hljs"},[t("code",null,`varlet-cli lint
`)],-1),dt=t("h4",null,"校验提交信息",-1),ot=t("pre",{class:"hljs"},[t("code",null,`varlet-cli commit-lint
`)],-1),lt=t("h4",null,"显示检查清单",-1),ct=t("pre",{class:"hljs"},[t("code",null,`varlet-cli checklist
`)],-1),st=t("h4",null,"生成更新日志",-1),nt=t("pre",{class:"hljs"},[t("code",null,`varlet-cli changelog
`)],-1),at=t("h4",null,"发布组件库",-1),it=t("pre",{class:"hljs"},[t("code",null,`varlet-cli release
`)],-1),rt=t("h4",null,"生成一个项目模板",-1),ht=t("pre",{class:"hljs"},[t("code",null,[e(`varlet-cli gen
...
--locale
  需要支持国际化
`)])],-1),_t=t("h4",null,"创建组件模板文件",-1),ut=t("pre",{class:"hljs"},[t("code",null,[e(`varlet-cli create
`),t("span",{class:"hljs-meta"},`
#`),t("span",{class:"bash"}," Options"),e(`
-n
--name
...
--locale
  需要支持国际化
`)])],-1),pt={class:"card"},gt={id:"发布前注意"},mt=t("ul",null,[t("li",null,[e("1."),t("code",null,"npm"),e(" 的仓库源必须指向 "),t("code",null,"npm"),e(" 官方镜像")]),t("li",null,[e("2.执行 "),t("code",null,"npm login"),e(" 进行登录")])],-1);function vt(ft,bt,yt,jt,xt,Ct){const c=s("router-link"),l=s("var-site-code-example");return i(),r("div",_,[u,t("div",p,[t("h3",g,[d(c,{to:"#介绍"},{default:o(()=>[e("#")]),_:1}),e("介绍")]),m]),t("div",v,[t("h3",f,[d(c,{to:"#特性"},{default:o(()=>[e("#")]),_:1}),e("特性")]),b]),t("div",y,[t("h3",j,[d(c,{to:"#快速开始"},{default:o(()=>[e("#")]),_:1}),e("快速开始")]),x,d(l,{"playground-ignore":""},{default:o(()=>[C]),_:1})]),V,t("div",k,[t("h3",N,[d(c,{to:"#配置文件"},{default:o(()=>[e("#")]),_:1}),e("配置文件")]),S]),t("div",M,[t("h3",R,[d(c,{to:"#自定义页面"},{default:o(()=>[e("#")]),_:1}),e("自定义页面")]),T,d(l,{"playground-ignore":""},{default:o(()=>[w]),_:1}),z,d(l,{"playground-ignore":""},{default:o(()=>[U]),_:1})]),t("div",$,[t("h3",B,[d(c,{to:"#命令相关"},{default:o(()=>[e("#")]),_:1}),e("命令相关")]),E,d(l,{"playground-ignore":""},{default:o(()=>[L]),_:1}),O,d(l,{"playground-ignore":""},{default:o(()=>[P]),_:1}),q,d(l,{"playground-ignore":""},{default:o(()=>[A]),_:1}),I,d(l,{"playground-ignore":""},{default:o(()=>[D]),_:1}),F,d(l,{"playground-ignore":""},{default:o(()=>[G]),_:1}),H,d(l,{"playground-ignore":""},{default:o(()=>[J]),_:1}),K,d(l,{"playground-ignore":""},{default:o(()=>[Q]),_:1}),W,d(l,{"playground-ignore":""},{default:o(()=>[X]),_:1}),Y,d(l,{"playground-ignore":""},{default:o(()=>[Z]),_:1}),tt,d(l,{"playground-ignore":""},{default:o(()=>[et]),_:1}),dt,d(l,{"playground-ignore":""},{default:o(()=>[ot]),_:1}),lt,d(l,{"playground-ignore":""},{default:o(()=>[ct]),_:1}),st,d(l,{"playground-ignore":""},{default:o(()=>[nt]),_:1}),at,d(l,{"playground-ignore":""},{default:o(()=>[it]),_:1}),rt,d(l,{"playground-ignore":""},{default:o(()=>[ht]),_:1}),_t,d(l,{"playground-ignore":""},{default:o(()=>[ut]),_:1})]),t("div",pt,[t("h3",gt,[d(c,{to:"#发布前注意"},{default:o(()=>[e("#")]),_:1}),e("发布前注意")]),mt])])}const kt=a(h,[["render",vt]]);export{kt as default};
