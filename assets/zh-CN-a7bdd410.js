import{_ as c,p as e,f as r,h as p,M as a,q as n,S as t,aq as h,P as s}from"./vue-router.esm-bundler-6a15ebdc.js";const o={components:{}},d={class:"varlet-site-doc"},j=a("h1",null,"表单",-1),i=a("div",{class:"card"},[a("h3",null,"介绍"),a("p",null,"提供了对所有表单组件进行控制的能力。")],-1),m={class:"card"},g=a("h3",null,"表单示例",-1),v=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
