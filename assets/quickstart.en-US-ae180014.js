...
`)])],-1),x={class:"card"},I={id:"Components Playground"},V=s("p",null,[a("We provide a web version of the component editor, which is convenient for you to quickly get started with each component of the component library, edit it online, share it with others, or download the code package to run locally. You can click the "),s("code",null,"{...}"),a(" icon in the upper right corner of the page or "),s("a",{href:"https://varlet.gitee.io/varlet-ui-playground"},"go here"),a(".")],-1),A={class:"card"},C={id:"File path note"},B=s("p",null,[a("In "),s("code",null,"@varlet/ui@2.7.0"),a(" and later versions, we recommend using the following file import method with omitting the suffix to be compatible with "),s("code",null,"js"),a(" and "),s("code",null,"mjs")],-1),N=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"import"),a(),s("span",{class:"hljs-string"},"'@varlet/ui/es/style'"),a(`
`)])],-1);function $(q,F,P,Q,S,W){const e=o("router-link"),l=o("var-site-code-example");return p(),r("div",h,[d,s("div",u,[s("h3",_,[n(e,{to:"#Intro"},{default:t(()=>[a("#")]),_:1}),a("Intro")]),m]),s("div",j,[s("h3",g,[n(e,{to:"#Install"},{default:t(()=>[a("#")]),_:1}),a("Install")]),v,y,n(l,{"playground-ignore":""},{default:t(()=>[f]),_:1}),w,n(l,{"playground-ignore":""},{default:t(()=>[k]),_:1}),n(l,{"playground-ignore":""},{default:t(()=>[b]),_:1})]),s("div",x,[s("h3",I,[n(e,{to:"#Components Playground"},{default:t(()=>[a("#")]),_:1}),a("Components Playground")]),V]),s("div",A,[s("h3",C,[n(e,{to:"#File path note"},{default:t(()=>[a("#")]),_:1}),a("File path note")]),B,n(l,{"playground-ignore":""},{default:t(()=>[N]),_:1})])])}const E=c(i,[["render",$]]);export{E as default};
