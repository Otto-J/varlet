...
`),s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
  ...
  />`)]),a(`
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),P=s("h2",null,"API",-1),S={class:"card"},V={id:"属性"},$=o("<table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td><code>v-model:show</code></td><td>是否显示遮罩层</td><td><em>boolean</em></td><td><code>false</code></td></tr><tr><td><code>lock-scroll</code></td><td>是否禁止滚动穿透，禁止时滚动遮罩层不会引发 body 的滚动</td><td><em>boolean</em></td><td><code>true</code></td></tr><tr><td><code>teleport</code></td><td>遮罩层挂载的位置</td><td><em>TeleportProps[&#39;to&#39;] | false</em></td><td><code>-</code></td></tr></tbody></table>",1),B={class:"card"},z={id:"事件"},T=s("table",null,[s("thead",null,[s("tr",null,[s("th",null,"事件名"),s("th",null,"说明"),s("th",null,"参数")])]),s("tbody",null,[s("tr",null,[s("td",null,[s("code",null,"click")]),s("td",null,"点击遮罩层时触发"),s("td",null,[s("code",null,"-")])])])],-1),A={class:"card"},E={id:"插槽"},I=s("table",null,[s("thead",null,[s("tr",null,[s("th",null,"插槽名"),s("th",null,"说明"),s("th",null,"参数")])]),s("tbody",null,[s("tr",null,[s("td",null,[s("code",null,"default")]),s("td",null,"遮罩层内容"),s("td",null,[s("code",null,"-")])])])],-1),Z={class:"card"},q={id:"样式变量"},D=o('<p>以下为组件使用的 css 变量，可以使用 <a href="#/zh-CN/style-provider">StyleProvider 组件</a> 进行样式定制。</p><table><thead><tr><th>变量名</th><th>默认值</th></tr></thead><tbody><tr><td><code>--overlay-background-color</code></td><td><code>rgba(0, 0, 0, .6)</code></td></tr></tbody></table>',2);function F(G,H,J,K,L,M){const n=e("router-link"),c=e("var-site-code-example");return d(),r("div",j,[i,s("div",u,[s("h3",_,[l(n,{to:"#介绍"},{default:t(()=>[a("#")]),_:1}),a("介绍")]),m]),s("div",v,[s("h3",g,[l(n,{to:"#基本使用"},{default:t(()=>[a("#")]),_:1}),a("基本使用")]),b,l(c,null,{default:t(()=>[f]),_:1})]),s("div",y,[s("h3",k,[l(n,{to:"#嵌入内容"},{default:t(()=>[a("#")]),_:1}),a("嵌入内容")]),l(c,null,{default:t(()=>[w]),_:1})]),s("div",x,[s("h3",N,[l(n,{to:"#注册事件"},{default:t(()=>[a("#")]),_:1}),a("注册事件")]),l(c,null,{default:t(()=>[C]),_:1})]),P,s("div",S,[s("h3",V,[l(n,{to:"#属性"},{default:t(()=>[a("#")]),_:1}),a("属性")]),$]),s("div",B,[s("h3",z,[l(n,{to:"#事件"},{default:t(()=>[a("#")]),_:1}),a("事件")]),T]),s("div",A,[s("h3",E,[l(n,{to:"#插槽"},{default:t(()=>[a("#")]),_:1}),a("插槽")]),I]),s("div",Z,[s("h3",q,[l(n,{to:"#样式变量"},{default:t(()=>[a("#")]),_:1}),a("样式变量")]),D])])}const Q=h(p,[["render",F]]);export{Q as default};
