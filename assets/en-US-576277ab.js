...
`)])],-1);function f(k,y,x,w,I,$){const n=o("router-link"),t=o("var-site-code-example");return r(),h("div",i,[d,s("div",m,[s("h3",_,[e(n,{to:"#Intro"},{default:l(()=>[a("#")]),_:1}),a("Intro")]),u]),s("div",j,[s("h3",g,[e(n,{to:"#Toggle Theme"},{default:l(()=>[a("#")]),_:1}),a("Toggle Theme")]),e(t,{"playground-ignore":""},{default:l(()=>[b]),_:1}),v,e(t,{"playground-ignore":""},{default:l(()=>[T]),_:1})])])}const N=c(p,[["render",f]]);export{N as default};
