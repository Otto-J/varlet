import{_ as h,p as d,f as p,h as o,M as a,q as t,S as l,P as s,aq as c}from"./vue-router-60af08e5.js";const r={components:{}},j={class:"varlet-site-doc"},m=a("h1",null,"菜单",-1),i={class:"card"},g={id:"介绍"},_=a("p",null,"当元素点击时显示一个菜单，通过控制弹出位置和偏移量改变菜单的显示位置。",-1),v={class:"card"},u={id:"基本使用"},b=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
