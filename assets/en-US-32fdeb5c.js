...
`),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
  ...
  `),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-button"),s(">")]),s(`
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),O=a("h2",null,"Function Call",-1),W={class:"card"},P=a("h3",null,"Basic Usage",-1),R=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
...
`),a("span",{class:"hljs-function"},[a("span",{class:"hljs-keyword"},"function"),s(),a("span",{class:"hljs-title"},"createSnackbar"),s("("),a("span",{class:"hljs-params"}),s(") ")]),s(`{
  Snackbar({
    `),a("span",{class:"hljs-attr"},"content"),s(": "),a("span",{class:"hljs-string"},"'Hello, World'"),s(`,
    `),a("span",{class:"hljs-attr"},"icon"),s(": h(VarIcon, { "),a("span",{class:"hljs-attr"},"name"),s(": "),a("span",{class:"hljs-string"},"'heart'"),s(", "),a("span",{class:"hljs-attr"},"style"),s(": { "),a("span",{class:"hljs-attr"},"paddingRight"),s(": "),a("span",{class:"hljs-string"},"'12px'"),s(` } }),
    `),a("span",{class:"hljs-attr"},"action"),s(": h(VarButton, { "),a("span",{class:"hljs-attr"},"size"),s(": "),a("span",{class:"hljs-string"},"'small'"),s(", "),a("span",{class:"hljs-attr"},"type"),s(": "),a("span",{class:"hljs-string"},"'primary'"),s(" }, "),a("span",{class:"hljs-string"},"'Varlet'"),s(`),
  })
}
`)]),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"script"),s(">")]),s(`
