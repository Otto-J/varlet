import{_ as r,p as d,f as o,h as p,M as a,q as l,S as t,P as s,aq as c}from"./vue-router-6d86b99d.js";const h={components:{}},j={class:"varlet-site-doc"},i=a("h1",null,"滑块",-1),m={class:"card"},u={id:"介绍"},_=a("p",null,"用于在给定范围内取值。",-1),g={class:"card"},v={id:"基本使用"},b=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
...
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),ls={class:"card"},ts={id:"垂直方向"},ns=a("p",null,[s("通过设置 "),a("code",null,"direction"),s(" 属性值为 "),a("code",null,"vertical"),s(" 来让滑块垂直显示。")],-1),es=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(">")]),a("span",{class:"javascript"},[s(`
`),a("span",{class:"hljs-keyword"},"import"),s(" { ref } "),a("span",{class:"hljs-keyword"},"from"),s(),a("span",{class:"hljs-string"},"'vue'"),s(`
