...
`)],-1),M=e("p",null,"The resulting route is as follows:",-1),B=e("pre",{class:"hljs"},[e("code",null,`/zh-CN/sponsor
/en-US/contributor
/zh-CN/changelog
/en-US/changelog
`)],-1),R={class:"card"},I={id:"Command related"},E=e("h4",null,"Start the development server",-1),G=e("pre",{class:"hljs"},[e("code",null,[t(`varlet-cli dev
`),e("span",{class:"hljs-meta"},"#"),e("span",{class:"bash"}," force mode"),t(`
varlet-cli dev -f
`),e("span",{class:"hljs-meta"},"#"),e("span",{class:"bash"}," draft mode"),t(`
varlet-cli dev -d
`)])],-1),L=e("h4",null,"Build a documentation site",-1),O=e("pre",{class:"hljs"},[e("code",null,`varlet-cli build
`)],-1),q=e("h4",null,"Preview documentation site",-1),P=e("pre",{class:"hljs"},[e("code",null,`varlet-cli preview
`)],-1),U=e("h4",null,"Compile component library",-1),A=e("pre",{class:"hljs"},[e("code",null,`varlet-cli compile
`)],-1),F=e("h4",null,"Run VSCode extension development environment",-1),$=e("pre",{class:"hljs"},[e("code",null,`varlet-cli dev:extension
`)],-1),Q=e("h4",null,"Build VSCode extension for production",-1),W=e("pre",{class:"hljs"},[e("code",null,`varlet-cli build:extension
`)],-1),H=e("h4",null,"Build svg to web fonts",-1),J=e("pre",{class:"hljs"},[e("code",null,`varlet-cli build:icons
`)],-1),K=e("h4",null,"Execute all unit tests",-1),X=e("pre",{class:"hljs"},[e("code",null,`varlet-cli test
`)],-1),Y=e("h4",null,"Execute unit tests in watch mode",-1),Z=e("pre",{class:"hljs"},[e("code",null,`varlet-cli test -w
or
varlet-cli test -wa
`)],-1),ee=e("h4",null,"Lint the code",-1),te=e("pre",{class:"hljs"},[e("code",null,`varlet-cli lint
`)],-1),oe=e("h4",null,"Lint git commit message",-1),de=e("pre",{class:"hljs"},[e("code",null,`varlet-cli commit-lint
`)],-1),ne=e("h4",null,"Show checklist",-1),le=e("pre",{class:"hljs"},[e("code",null,`varlet-cli checklist
`)],-1),se=e("h4",null,"Generate changelog",-1),ce=e("pre",{class:"hljs"},[e("code",null,`varlet-cli changelog
`)],-1),ie=e("h4",null,"Release component library",-1),re=e("pre",{class:"hljs"},[e("code",null,`varlet-cli release
`)],-1),ae=e("h4",null,"Generate a project template",-1),he=e("pre",{class:"hljs"},[e("code",null,[t(`varlet-cli gen
...
`)])],-1),ue=e("h4",null,"Create a component template file",-1),pe=e("pre",{class:"hljs"},[e("code",null,[t(`varlet-cli create
`),e("span",{class:"hljs-meta"},`
#`),e("span",{class:"bash"}," Options"),t(`
-n
--name
...
--locale
  Need to support internationalization
`)])],-1),me={class:"card"},_e={id:"Note before publish"},ge=e("ul",null,[e("li",null,[t("1."),e("code",null,"npm"),t(" repository registry must set to "),e("code",null,"npm"),t(" official mirror")]),e("li",null,[t("2.Execute "),e("code",null,"npm login"),t(" to log in")])],-1);function fe(ve,be,ye,je,xe,we){const l=s("router-link"),n=s("var-site-code-example");return r(),a("div",u,[p,e("div",m,[e("h3",_,[o(l,{to:"#Intro"},{default:d(()=>[t("#")]),_:1}),t("Intro")]),g]),e("div",f,[e("h3",v,[o(l,{to:"#Features"},{default:d(()=>[t("#")]),_:1}),t("Features")]),b]),e("div",y,[e("h3",j,[o(l,{to:"#Quickstart"},{default:d(()=>[t("#")]),_:1}),t("Quickstart")]),x,o(n,{"playground-ignore":""},{default:d(()=>[w]),_:1})]),C,e("div",T,[e("h3",k,[o(l,{to:"#Configuration file"},{default:d(()=>[t("#")]),_:1}),t("Configuration file")]),S]),e("div",N,[e("h3",D,[o(l,{to:"#Custom pages"},{default:d(()=>[t("#")]),_:1}),t("Custom pages")]),V,o(n,{"playground-ignore":""},{default:d(()=>[z]),_:1}),M,o(n,{"playground-ignore":""},{default:d(()=>[B]),_:1})]),e("div",R,[e("h3",I,[o(l,{to:"#Command related"},{default:d(()=>[t("#")]),_:1}),t("Command related")]),E,o(n,{"playground-ignore":""},{default:d(()=>[G]),_:1}),L,o(n,{"playground-ignore":""},{default:d(()=>[O]),_:1}),q,o(n,{"playground-ignore":""},{default:d(()=>[P]),_:1}),U,o(n,{"playground-ignore":""},{default:d(()=>[A]),_:1}),F,o(n,{"playground-ignore":""},{default:d(()=>[$]),_:1}),Q,o(n,{"playground-ignore":""},{default:d(()=>[W]),_:1}),H,o(n,{"playground-ignore":""},{default:d(()=>[J]),_:1}),K,o(n,{"playground-ignore":""},{default:d(()=>[X]),_:1}),Y,o(n,{"playground-ignore":""},{default:d(()=>[Z]),_:1}),ee,o(n,{"playground-ignore":""},{default:d(()=>[te]),_:1}),oe,o(n,{"playground-ignore":""},{default:d(()=>[de]),_:1}),ne,o(n,{"playground-ignore":""},{default:d(()=>[le]),_:1}),se,o(n,{"playground-ignore":""},{default:d(()=>[ce]),_:1}),ie,o(n,{"playground-ignore":""},{default:d(()=>[re]),_:1}),ae,o(n,{"playground-ignore":""},{default:d(()=>[he]),_:1}),ue,o(n,{"playground-ignore":""},{default:d(()=>[pe]),_:1})]),e("div",me,[e("h3",_e,[o(l,{to:"#Note before publish"},{default:d(()=>[t("#")]),_:1}),t("Note before publish")]),ge])])}const Te=i(h,[["render",fe]]);export{Te as default};
