import{_ as h,p as d,f as o,h as p,M as a,q as t,S as l,P as s,aq as e}from"./vue-router-6d66666a.js";const r={components:{}},j={class:"varlet-site-doc"},i=a("h1",null,"Table",-1),m={class:"card"},g={id:"Intro"},b=a("p",null,"A minimal table, when you need to display some data in the form of a table, you may use it.",-1),u={class:"card"},_={id:"Basic Usage"},f=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`)])],-1),y={class:"card"},v={id:"Footer Slots"},x=a("p",null,[s("You can insert something in the tail slot, the most common is to insert a "),a("code",null,"Pagination"),s(".")],-1),S=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
