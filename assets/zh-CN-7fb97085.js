...
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),A=a("h2",null,"API",-1),E={class:"card"},I={id:"属性"},Q=c("<table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td><code>time</code></td><td>倒计时时长（ms）</td><td><em>string | number</em></td><td><code>0</code></td></tr><tr><td><code>format</code></td><td>时间格式</td><td><em>string</em></td><td><code>HH : mm : ss</code></td></tr><tr><td><code>auto-start</code></td><td>是否自动开始倒计时</td><td><em>boolean</em></td><td><code>true</code></td></tr></tbody></table>",1),Z={class:"card"},F={id:"format 格式"},G=c("<table><thead><tr><th>格式</th><th>说明</th></tr></thead><tbody><tr><td><code>DD</code></td><td>天数</td></tr><tr><td><code>HH</code></td><td>小时</td></tr><tr><td><code>mm</code></td><td>分钟</td></tr><tr><td><code>ss</code></td><td>秒数</td></tr><tr><td><code>S</code></td><td>毫秒（1位）</td></tr><tr><td><code>SS</code></td><td>毫秒（2位）</td></tr><tr><td><code>SSS</code></td><td>毫秒（3位）</td></tr></tbody></table>",1),J={class:"card"},K={id:"事件"},L=c("<table><thead><tr><th>事件名</th><th>说明</th><th>回调参数</th></tr></thead><tbody><tr><td><code>end</code></td><td>倒计时结束时触发</td><td><code>-</code></td></tr><tr><td><code>change</code></td><td>倒计时变化时触发</td><td><code>timeData: TimeData</code></td></tr></tbody></table>",1),M={class:"card"},O={id:"插槽"},R=a("table",null,[a("thead",null,[a("tr",null,[a("th",null,"名称"),a("th",null,"说明"),a("th",null,"参数")])]),a("tbody",null,[a("tr",null,[a("td",null,[a("code",null,"default")]),a("td",null,"自定义内容"),a("td",null,[a("code",null,"timeData: TimeData")])])])],-1),U={class:"card"},W={id:"TimeData 格式"},X=c("<table><thead><tr><th>名称</th><th>说明</th><th>类型</th></tr></thead><tbody><tr><td><code>days</code></td><td>剩余天数</td><td><code>number</code></td></tr><tr><td><code>hours</code></td><td>剩余小时</td><td><code>number</code></td></tr><tr><td><code>minutes</code></td><td>剩余分钟</td><td><code>number</code></td></tr><tr><td><code>seconds</code></td><td>剩余秒数</td><td><code>number</code></td></tr><tr><td><code>milliseconds</code></td><td>剩余毫秒</td><td><code>number</code></td></tr></tbody></table>",1),Y={class:"card"},ss={id:"方法"},as=c("<p>通过 ref 可以获取到 CountDown 实例并调用实例方法.</p><table><thead><tr><th>方法名</th><th>说明</th><th>参数</th><th>返回值</th></tr></thead><tbody><tr><td><code>start</code></td><td>开始倒计时</td><td><code>-</code></td><td><code>-</code></td></tr><tr><td><code>pause</code></td><td>暂停倒计时</td><td><code>-</code></td><td><code>-</code></td></tr><tr><td><code>reset</code></td><td>重设倒计时，若 <code>auto-start</code> 为 <code>true</code>，重设后会自动开始倒计时</td><td><code>-</code></td><td><code>-</code></td></tr></tbody></table>",2),ts={class:"card"},ls={id:"样式变量"},ns=c('<p>以下为组件使用的 css 变量，可以使用 <a href="#/zh-CN/style-provider">StyleProvider 组件</a> 进行样式定制。</p><table><thead><tr><th>变量名</th><th>默认值</th></tr></thead><tbody><tr><td><code>--countdown-text-color</code></td><td><code>#555</code></td></tr></tbody></table>',2);function cs(es,ds,os,hs,rs,ps){const n=d("router-link"),e=d("var-site-code-example");return h(),r("div",j,[i,a("div",m,[a("h3",u,[t(n,{to:"#介绍"},{default:l(()=>[s("#")]),_:1}),s("介绍")]),_]),a("div",g,[a("h3",b,[t(n,{to:"#基本使用"},{default:l(()=>[s("#")]),_:1}),s("基本使用")]),f,t(e,null,{default:l(()=>[w]),_:1})]),a("div",v,[a("h3",y,[t(n,{to:"#自定义格式"},{default:l(()=>[s("#")]),_:1}),s("自定义格式")]),k,t(e,null,{default:l(()=>[x]),_:1})]),a("div",S,[a("h3",D,[t(n,{to:"#显示毫秒"},{default:l(()=>[s("#")]),_:1}),s("显示毫秒")]),H,t(e,null,{default:l(()=>[$]),_:1})]),a("div",N,[a("h3",T,[t(n,{to:"#自定义样式"},{default:l(()=>[s("#")]),_:1}),s("自定义样式")]),C,t(e,null,{default:l(()=>[V]),_:1})]),a("div",z,[a("h3",B,[t(n,{to:"#手动控制"},{default:l(()=>[s("#")]),_:1}),s("手动控制")]),P,t(e,null,{default:l(()=>[q]),_:1})]),A,a("div",E,[a("h3",I,[t(n,{to:"#属性"},{default:l(()=>[s("#")]),_:1}),s("属性")]),Q]),a("div",Z,[a("h3",F,[t(n,{to:"#format 格式"},{default:l(()=>[s("#")]),_:1}),s("format 格式")]),G]),a("div",J,[a("h3",K,[t(n,{to:"#事件"},{default:l(()=>[s("#")]),_:1}),s("事件")]),L]),a("div",M,[a("h3",O,[t(n,{to:"#插槽"},{default:l(()=>[s("#")]),_:1}),s("插槽")]),R]),a("div",U,[a("h3",W,[t(n,{to:"#TimeData 格式"},{default:l(()=>[s("#")]),_:1}),s("TimeData 格式")]),X]),a("div",Y,[a("h3",ss,[t(n,{to:"#方法"},{default:l(()=>[s("#")]),_:1}),s("方法")]),as]),a("div",ts,[a("h3",ls,[t(n,{to:"#样式变量"},{default:l(()=>[s("#")]),_:1}),s("样式变量")]),ns])])}const is=o(p,[["render",cs]]);export{is as default};
