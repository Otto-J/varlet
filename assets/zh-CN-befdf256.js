import{_ as h,p as d,f as o,h as p,M as a,q as t,S as l,P as s,aq as e}from"./vue-router-96d7bda4.js";const r={components:{}},j={class:"varlet-site-doc"},i=a("h1",null,"表格",-1),m={class:"card"},g={id:"介绍"},b=a("p",null,"一个极简的表格，当你需要以表格的形式展示一些数据的时候，可能会用的上它。",-1),_={class:"card"},u={id:"基本使用"},f=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`)])],-1),y={class:"card"},v={id:"尾部插槽"},x=a("p",null,"可以在尾部插槽中插入一些东西，最常见的是插入分页组件。",-1),k=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
