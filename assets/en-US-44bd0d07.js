import{_ as e,p as c,f as r,h as o,M as s,q as l,S as n,P as a,aq as p}from"./vue-router.esm-bundler-6be07501.js";const i={components:{}},h={class:"varlet-site-doc"},d=s("h1",null,"Lazy",-1),j=s("div",{class:"card"},[s("h3",null,"Intro"),s("p",null,"Load when the image is visible.")],-1),m={class:"card"},g=s("h3",null,"Basic Use",-1),u=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
...
`)])],-1),_={class:"card"},b=s("h3",null,"Background Image Lazy Load",-1),v=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
...
`)])],-1),P=p('<h2>API</h2><div class="card"><h3>Plugin Options</h3><table><thead><tr><th>Option</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td><code>loading</code></td><td>Loading images, if possible, select images that load quickly</td><td><em>string</em></td><td><code>Pixel transparent picture</code></td></tr><tr><td><code>error</code></td><td>Load failed to display the picture</td><td><em>string</em></td><td><code>Pixel transparent picture</code></td></tr><tr><td><code>attempt</code></td><td>The number of times a load failed to reload</td><td><em>number</em></td><td><code>3</code></td></tr><tr><td><code>throttleWait</code></td><td>throttle wait time, The higher the value, the lower the trigger frequency</td><td><em>number</em></td><td><code>300</code></td></tr><tr><td><code>events</code></td><td>A list of events that trigger visibility detection registration</td><td><em>string[]</em></td><td><code>[&#39;scroll&#39;...]</code></td></tr><tr><td><code>filter</code></td><td>Attribute interceptor function</td><td><em>(lazy: Lazy) =&gt; void</em></td><td><code>() =&gt; void</code></td></tr></tbody></table></div>',2);function B(T,q,I,N,S,V){const t=c("var-site-code-example");return r(),o("div",h,[d,j,s("div",m,[g,l(t,null,{default:n(()=>[u]),_:1})]),s("div",_,[b,l(t,null,{default:n(()=>[v]),_:1})]),s("div",y,[f,x,l(t,null,{default:n(()=>[z]),_:1})]),s("div",w,[k,L,l(t,{"playground-ignore":""},{default:n(()=>[A]),_:1})]),P])}const C=e(i,[["render",B]]);export{C as default};
