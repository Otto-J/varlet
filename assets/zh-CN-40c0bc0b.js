import{_ as e,p as c,f as h,h as d,M as a,q as t,S as n,aq as p,P as s}from"./vue-router.esm-bundler-6be07501.js";const r={components:{}},j={class:"varlet-site-doc"},o=a("h1",null,"表格",-1),m=a("div",{class:"card"},[a("h3",null,"介绍"),a("p",null,"一个极简的表格，当你需要以表格的形式展示一些数据的时候，可能会用的上它。")],-1),i={class:"card"},g=a("h3",null,"基本使用",-1),b=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
