import{_ as l,p as n,f as e,h as d,M as t,q as c,S as o,aq as r,P as s}from"./vue-router.esm-bundler-1e250ce9.js";const h={components:{}},p={class:"varlet-site-doc"},i=t("h1",null,"加载条",-1),j=t("div",{class:"card"},[t("h3",null,"介绍"),t("p",null,"页面顶部显示加载进度。")],-1),m={class:"card"},g=t("h3",null,"基本使用",-1),u=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
