import{_ as e,p as c,f as o,h as r,M as s,q as t,S as l,P as a,aq as i}from"./vue-router.esm-bundler-54754668.js";const h={components:{}},p={class:"varlet-site-doc"},d=s("h1",null,"Icon",-1),j=s("div",{class:"card"},[s("h3",null,"Intro"),s("p",null,[a("Font based icon library, also support web images. Font icons are from "),s("a",{href:"https://materialdesignicons.com/"},"Material Design Icon"),a(".")])],-1),m={class:"card"},g=s("h3",null,"Icon Size",-1),u=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
...
`)])],-1),D={class:"card"},E=s("h3",null,"Custom Icons",-1),F=s("p",null,[a("First you need to set up your own font and install it into your project. Let's assume that we extend a font named "),s("code",null,"my-icons"),a(".")],-1),P=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"/* Set the font */"),a(`
