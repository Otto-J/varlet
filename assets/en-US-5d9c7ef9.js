...
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),y={class:"card"},v={id:"Custom Format"},S=t("p",null,[s("Use "),t("code",null,"format"),s(" to set time text.")],-1),k=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
`),t("span",{class:"hljs-keyword"},"import"),s(" { ref } "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'vue'"),s(`
...
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),x={class:"card"},D={id:"Show Millisecond"},C=t("p",null,[s("Use "),t("code",null,"S"),s(" text to show millisecond.")],-1),M=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
`),t("span",{class:"hljs-keyword"},"import"),s(" { ref } "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'vue'"),s(`
...
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),U={class:"card"},H={id:"Custom Style"},T=t("p",null,[s("Use "),t("code",null,"slot"),s(" to set custom countdown style.")],-1),P=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),B=t("h2",null,"API",-1),N={class:"card"},F={id:"Props"},A=e("<table><thead><tr><th>Prop</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td><code>time</code></td><td>Total time(ms)</td><td><em>string | number</em></td><td><code>0</code></td></tr><tr><td><code>format</code></td><td>Time format</td><td><em>string</em></td><td><code>HH : mm : ss</code></td></tr><tr><td><code>auto-start</code></td><td>Whether to auto start count down</td><td><em>boolean</em></td><td><code>true</code></td></tr></tbody></table>",1),I={class:"card"},z={id:"Available formats"},q=e("<table><thead><tr><th>Format</th><th>Description</th></tr></thead><tbody><tr><td><code>DD</code></td><td>Day</td></tr><tr><td><code>HH</code></td><td>Hour</td></tr><tr><td><code>mm</code></td><td>Minute</td></tr><tr><td><code>ss</code></td><td>Second</td></tr><tr><td><code>S</code></td><td>Millisecond, 1-digit</td></tr><tr><td><code>SS</code></td><td>Millisecond, 2-digit</td></tr><tr><td><code>SSS</code></td><td>Millisecond, 3-digit</td></tr></tbody></table>",1),Q={class:"card"},W={id:"Events"},Z=e("<table><thead><tr><th>Event</th><th>Description</th><th>arguments</th></tr></thead><tbody><tr><td><code>end</code></td><td>Emitted after countdown ended</td><td><code>-</code></td></tr><tr><td><code>change</code></td><td>Emitted after countdown changed</td><td><code>timeData: TimeData</code></td></tr></tbody></table>",1),G={class:"card"},J={id:"Slots"},K=t("table",null,[t("thead",null,[t("tr",null,[t("th",null,"Name"),t("th",null,"Description"),t("th",null,"SlotProps")])]),t("tbody",null,[t("tr",null,[t("td",null,[t("code",null,"default")]),t("td",null,"Custom content"),t("td",null,[t("code",null,"timeData: TimeData")])])])],-1),L={class:"card"},O={id:"TimeData Structure"},X=e("<table><thead><tr><th>Name</th><th>Description</th><th>Type</th></tr></thead><tbody><tr><td><code>days</code></td><td>Remain days</td><td><code>number</code></td></tr><tr><td><code>hours</code></td><td>Remain hours</td><td><code>number</code></td></tr><tr><td><code>minutes</code></td><td>Remain minutes</td><td><code>number</code></td></tr><tr><td><code>seconds</code></td><td>Remain seconds</td><td><code>number</code></td></tr><tr><td><code>milliseconds</code></td><td>Remain milliseconds</td><td><code>number</code></td></tr></tbody></table>",1),Y={class:"card"},ss={id:"Methods"},ts=e("<p>Use ref to get CountDown instance and call instance methods.</p><table><thead><tr><th>Method</th><th>Description</th><th>arguments</th><th>Return</th></tr></thead><tbody><tr><td><code>start</code></td><td>Start countdown</td><td><code>-</code></td><td><code>-</code></td></tr><tr><td><code>pause</code></td><td>Pause countdown</td><td><code>-</code></td><td><code>-</code></td></tr><tr><td><code>reset</code></td><td>Reset countdown</td><td><code>-</code></td><td><code>-</code></td></tr></tbody></table>",2),as={class:"card"},ns={id:"Style Variables"},ls=e('<p>Here are the CSS variables used by the component, Styles can be customized using <a href="#/en-US/style-provider">StyleProvider</a>.</p><table><thead><tr><th>Variable</th><th>Default</th></tr></thead><tbody><tr><td><code>--countdown-text-color</code></td><td><code>#555</code></td></tr></tbody></table>',2);function es(cs,os,ds,rs,hs,ps){const l=o("router-link"),c=o("var-site-code-example");return r(),h("div",i,[j,t("div",u,[t("h3",m,[a(l,{to:"#Intro"},{default:n(()=>[s("#")]),_:1}),s("Intro")]),_]),t("div",g,[t("h3",b,[a(l,{to:"#Basic Usage"},{default:n(()=>[s("#")]),_:1}),s("Basic Usage")]),f,a(c,null,{default:n(()=>[w]),_:1})]),t("div",y,[t("h3",v,[a(l,{to:"#Custom Format"},{default:n(()=>[s("#")]),_:1}),s("Custom Format")]),S,a(c,null,{default:n(()=>[k]),_:1})]),t("div",x,[t("h3",D,[a(l,{to:"#Show Millisecond"},{default:n(()=>[s("#")]),_:1}),s("Show Millisecond")]),C,a(c,null,{default:n(()=>[M]),_:1})]),t("div",U,[t("h3",H,[a(l,{to:"#Custom Style"},{default:n(()=>[s("#")]),_:1}),s("Custom Style")]),T,a(c,null,{default:n(()=>[P]),_:1})]),t("div",V,[t("h3",E,[a(l,{to:"#Manual Control"},{default:n(()=>[s("#")]),_:1}),s("Manual Control")]),R,a(c,null,{default:n(()=>[$]),_:1})]),B,t("div",N,[t("h3",F,[a(l,{to:"#Props"},{default:n(()=>[s("#")]),_:1}),s("Props")]),A]),t("div",I,[t("h3",z,[a(l,{to:"#Available formats"},{default:n(()=>[s("#")]),_:1}),s("Available formats")]),q]),t("div",Q,[t("h3",W,[a(l,{to:"#Events"},{default:n(()=>[s("#")]),_:1}),s("Events")]),Z]),t("div",G,[t("h3",J,[a(l,{to:"#Slots"},{default:n(()=>[s("#")]),_:1}),s("Slots")]),K]),t("div",L,[t("h3",O,[a(l,{to:"#TimeData Structure"},{default:n(()=>[s("#")]),_:1}),s("TimeData Structure")]),X]),t("div",Y,[t("h3",ss,[a(l,{to:"#Methods"},{default:n(()=>[s("#")]),_:1}),s("Methods")]),ts]),t("div",as,[t("h3",ns,[a(l,{to:"#Style Variables"},{default:n(()=>[s("#")]),_:1}),s("Style Variables")]),ls])])}const js=d(p,[["render",es]]);export{js as default};
