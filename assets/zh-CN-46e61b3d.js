...
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),$=s("h2",null,"API",-1),B={class:"card"},R={id:"属性"},A=p("<table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td><code>style-vars</code></td><td>CSS 变量</td><td><em>Record&lt;string, string&gt;</em></td><td><code>{}</code></td></tr><tr><td><code>tag</code></td><td>自定义标签名</td><td><em>string</em></td><td><code>div</code></td></tr></tbody></table>",1),E={class:"card"},I={id:"插槽"},U=s("table",null,[s("thead",null,[s("tr",null,[s("th",null,"插槽名"),s("th",null,"说明"),s("th",null,"参数")])]),s("tbody",null,[s("tr",null,[s("td",null,[s("code",null,"default")]),s("td",null,"组件内容"),s("td",null,[s("code",null,"-")])])])],-1);function W(Z,q,D,F,G,H){const t=c("router-link"),e=c("var-site-code-example");return o(),h("div",d,[j,s("div",u,[s("h3",m,[l(t,{to:"#介绍"},{default:n(()=>[a("#")]),_:1}),a("介绍")]),_]),s("div",b,[s("h3",g,[l(t,{to:"#基本样式变量"},{default:n(()=>[a("#")]),_:1}),a("基本样式变量")]),v,l(e,{"playground-ignore":""},{default:n(()=>[f]),_:1})]),s("div",y,[s("h3",k,[l(t,{to:"#运行时修改样式"},{default:n(()=>[a("#")]),_:1}),a("运行时修改样式")]),x]),s("div",w,[s("h3",S,[l(t,{to:"#组件式调用"},{default:n(()=>[a("#")]),_:1}),a("组件式调用")]),z,l(e,null,{default:n(()=>[V]),_:1})]),s("div",T,[s("h3",C,[l(t,{to:"#函数式调用"},{default:n(()=>[a("#")]),_:1}),a("函数式调用")]),P,l(e,null,{default:n(()=>[N]),_:1})]),$,s("div",B,[s("h3",R,[l(t,{to:"#属性"},{default:n(()=>[a("#")]),_:1}),a("属性")]),A]),s("div",E,[s("h3",I,[l(t,{to:"#插槽"},{default:n(()=>[a("#")]),_:1}),a("插槽")]),U])])}const K=r(i,[["render",W]]);export{K as default};
