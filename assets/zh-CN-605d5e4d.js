...
`),s("span",{class:"hljs-tag"},[l("<"),s("span",{class:"hljs-name"},"template"),l(">")]),l(`
  ...
  `),s("span",{class:"hljs-tag"},[l("</"),s("span",{class:"hljs-name"},"var-pull-refresh"),l(">")]),l(`
`),s("span",{class:"hljs-tag"},[l("</"),s("span",{class:"hljs-name"},"template"),l(">")]),l(`
`)])],-1),C={class:"card"},L={id:"注意"},N=s("p",null,[l("当 "),s("code",null,"PullRefresh"),l(" 容器高度为 "),s("code",null,"0"),l(" 时会导致下拉功能失效，所以需保证其子元素高度"),s("strong",null,"不为"),l(),s("code",null,"0"),l(" 或为 "),s("code",null,"PullRefresh"),l(" 容器设置高度:")],-1),R=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[l("<"),s("span",{class:"hljs-name"},"template"),l(">")]),l(`
  `),s("span",{class:"hljs-tag"},[l("<"),s("span",{class:"hljs-name"},"var-pull-refresh"),l(">")]),l(`
