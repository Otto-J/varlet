...
`)])],-1),y={class:"card"},x={id:"背景图懒加载"},f=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`)]),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"style"),s(">")]),s(`
`)])],-1),z={class:"card"},k={id:"内联属性"},w=a("p",null,[s("可以通过内联属性修改 "),a("code",null,"loading"),s("、 "),a("code",null,"error"),s(" 图片和"),a("code",null,"加载失败时尝试重新加载的次数"),s("。")],-1),N=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`)])],-1),B=a("h2",null,"API",-1),C={class:"card"},P={id:"插件选项"},S=r("<table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td><code>loading</code></td><td>加载中的图片，尽可能选择加载速度很快的图片</td><td><em>string</em></td><td><code>1像素透明图片</code></td></tr><tr><td><code>error</code></td><td>加载失败显示的图片</td><td><em>string</em></td><td><code>1像素透明图片</code></td></tr><tr><td><code>attempt</code></td><td>加载失败时尝试重新加载的次数</td><td><em>number</em></td><td><code>3</code></td></tr><tr><td><code>throttleWait</code></td><td>节流时间，数值越大事件触发频率越低</td><td><em>number</em></td><td><code>300</code></td></tr><tr><td><code>events</code></td><td>触发可见性检测注册的事件列表</td><td><em>string[]</em></td><td><code>[&#39;scroll&#39;...]</code></td></tr><tr><td><code>filter</code></td><td>属性拦截函数</td><td><em>(lazy: Lazy) =&gt; void</em></td><td><code>() =&gt; void</code></td></tr></tbody></table>",1);function W(q,E,I,M,T,D){const n=c("router-link"),e=c("var-site-code-example");return h(),p("div",i,[j,a("div",m,[a("h3",_,[t(n,{to:"#介绍"},{default:l(()=>[s("#")]),_:1}),s("介绍")]),g]),a("div",u,[a("h3",v,[t(n,{to:"#基本用法"},{default:l(()=>[s("#")]),_:1}),s("基本用法")]),t(e,null,{default:l(()=>[b]),_:1})]),a("div",y,[a("h3",x,[t(n,{to:"#背景图懒加载"},{default:l(()=>[s("#")]),_:1}),s("背景图懒加载")]),t(e,null,{default:l(()=>[f]),_:1})]),a("div",z,[a("h3",k,[t(n,{to:"#内联属性"},{default:l(()=>[s("#")]),_:1}),s("内联属性")]),w,t(e,null,{default:l(()=>[N]),_:1})]),a("div",L,[a("h3",V,[t(n,{to:"#插件"},{default:l(()=>[s("#")]),_:1}),s("插件")]),$,t(e,{"playground-ignore":""},{default:l(()=>[A]),_:1})]),B,a("div",C,[a("h3",P,[t(n,{to:"#插件选项"},{default:l(()=>[s("#")]),_:1}),s("插件选项")]),S])])}const G=o(d,[["render",W]]);export{G as default};
