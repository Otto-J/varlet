...
`)]),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"style"),s(">")]),s(`
`)])],-1),x={class:"card"},E={id:"Selectively Enable For Different Devices"},B=a("p",null,[s("Considering the differences in "),a("code",null,"hover"),s(" effects on different platforms, the hover command can only be enabled on specific platforms.")],-1),S=a("h4",null,"Only Enabled On Desktop",-1),O=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-paper"),s(),a("span",{class:"hljs-attr"},"v-hover:desktop"),s("="),a("span",{class:"hljs-string"},`"{ color: '#fff' }"`),s('">')]),s("HOVER"),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-paper"),s(">")]),s(`
...
`)])],-1);function V(F,$,R,Y,C,I){const e=c("router-link"),t=c("var-site-code-example");return p(),h("div",i,[j,a("div",d,[a("h3",u,[n(e,{to:"#Intro"},{default:l(()=>[s("#")]),_:1}),s("Intro")]),g]),a("div",m,[a("h3",_,[n(e,{to:"#Style Binding"},{default:l(()=>[s("#")]),_:1}),s("Style Binding")]),v,n(t,null,{default:l(()=>[f]),_:1})]),a("div",b,[a("h3",y,[n(e,{to:"#Function Binding"},{default:l(()=>[s("#")]),_:1}),s("Function Binding")]),k,n(t,null,{default:l(()=>[w]),_:1})]),a("div",x,[a("h3",E,[n(e,{to:"#Selectively Enable For Different Devices"},{default:l(()=>[s("#")]),_:1}),s("Selectively Enable For Different Devices")]),B,S,n(t,{"playground-ignore":""},{default:l(()=>[O]),_:1}),D,n(t,{"playground-ignore":""},{default:l(()=>[H]),_:1})])])}const T=r(o,[["render",V]]);export{T as default};
