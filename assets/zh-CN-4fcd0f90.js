...
`)])],-1);function R(Y,B,C,z,q,M){const t=c("router-link"),e=c("var-site-code-example");return r(),h("div",i,[j,a("div",d,[a("h3",u,[l(t,{to:"#介绍"},{default:n(()=>[s("#")]),_:1}),s("介绍")]),_]),a("div",m,[a("h3",g,[l(t,{to:"#样式绑定"},{default:n(()=>[s("#")]),_:1}),s("样式绑定")]),v,l(e,null,{default:n(()=>[f]),_:1})]),a("div",b,[a("h3",y,[l(t,{to:"#函数绑定"},{default:n(()=>[s("#")]),_:1}),s("函数绑定")]),k,l(e,null,{default:n(()=>[x]),_:1})]),a("div",w,[a("h3",V,[l(t,{to:"#针对不同设备选择性启用"},{default:n(()=>[s("#")]),_:1}),s("针对不同设备选择性启用")]),H,E,l(e,{"playground-ignore":""},{default:n(()=>[$]),_:1}),N,l(e,{"playground-ignore":""},{default:n(()=>[O]),_:1})])])}const S=p(o,[["render",R]]);export{S as default};
