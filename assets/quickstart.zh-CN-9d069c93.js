...
`)])],-1);function q(z,D,E,P,S,T){const t=c("router-link"),e=c("var-site-code-example");return o(),r("div",h,[i,s("div",_,[s("h3",u,[l(t,{to:"#介绍"},{default:n(()=>[a("#")]),_:1}),a("介绍")]),j]),s("div",m,[s("h3",v,[l(t,{to:"#安装"},{default:n(()=>[a("#")]),_:1}),a("安装")]),g,y,l(e,{"playground-ignore":""},{default:n(()=>[f]),_:1}),k,l(e,{"playground-ignore":""},{default:n(()=>[w]),_:1}),l(e,{"playground-ignore":""},{default:n(()=>[b]),_:1})]),s("div",V,[s("h3",x,[l(t,{to:"#在线编辑组件"},{default:n(()=>[a("#")]),_:1}),a("在线编辑组件")]),A]),s("div",N,[s("h3",C,[l(t,{to:"#文件路径注意"},{default:n(()=>[a("#")]),_:1}),a("文件路径注意")]),$,l(e,{"playground-ignore":""},{default:n(()=>[B]),_:1})])])}const F=p(d,[["render",q]]);export{F as default};
