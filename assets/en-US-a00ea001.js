...
`),s("span",{class:"hljs-tag"},[t("</"),s("span",{class:"hljs-name"},"template"),t(">")]),t(`
`)])],-1),I={class:"card"},A=s("h3",null,"Asynchronous change",-1),M=s("p",null,[t("In some scenarios, you may need to wait for the server to return successfully before making changes. "),s("code",null,"lazy-change"),t(" prevents binding value updates on the component itself. Register "),s("code",null,"before-change"),t(" events for manual updates.")],-1),N=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"script"),t(),s("span",{class:"hljs-attr"},"setup"),t(">")]),s("span",{class:"javascript"},[t(`
`),s("span",{class:"hljs-keyword"},"import"),t(" { ref } "),s("span",{class:"hljs-keyword"},"from"),t(),s("span",{class:"hljs-string"},"'vue'"),t(`
