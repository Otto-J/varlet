...
`)]),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"style"),s(">")]),s(`
`)])],-1),x=t("h2",null,"API",-1),N={class:"card"},V={id:"属性"},$=e("<table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td><code>offset-top</code></td><td>吸顶距离</td><td><em>string | number</em></td><td><code>0</code></td></tr><tr><td><code>z-index</code></td><td>吸顶时的层级</td><td><em>string | number</em></td><td><code>0</code></td></tr><tr><td><code>css-mode</code></td><td>开启原生 <code>css sticky</code> 模式</td><td><em>boolean</em></td><td><code>false</code></td></tr><tr><td><code>disabled</code></td><td>禁用吸顶, 设置为 <code>true</code> 时, 元素会回到文档流中</td><td><em>boolean</em></td><td><code>false</code></td></tr></tbody></table>",1),w={class:"card"},z={id:"方法"},B=e("<table><thead><tr><th>方法名</th><th>说明</th><th>参数</th><th>返回值</th></tr></thead><tbody><tr><td><code>resize</code></td><td>触发粘性布局重绘</td><td><code>-</code></td><td><code>Promise&lt;void&gt;</code></td></tr></tbody></table>",1),C={class:"card"},P={id:"事件"},S=e("<table><thead><tr><th>事件名</th><th>说明</th><th>参数</th></tr></thead><tbody><tr><td><code>scroll</code></td><td>当滚动容器滚动时触发</td><td><code>offsetTop: number</code> 距离顶部的 px 值 <br> <code>isFixed: boolean</code> 是否吸顶</td></tr></tbody></table>",1),T={class:"card"},q={id:"插槽"},A=t("table",null,[t("thead",null,[t("tr",null,[t("th",null,"插槽名"),t("th",null,"说明"),t("th",null,"参数")])]),t("tbody",null,[t("tr",null,[t("td",null,[t("code",null,"default")]),t("td",null,"粘性布局的内容"),t("td",null,[t("code",null,"-")])])])],-1);function E(F,I,M,D,G,H){const n=d("router-link"),c=d("var-site-code-example");return h(),p("div",i,[j,t("div",_,[t("h3",m,[a(n,{to:"#介绍"},{default:l(()=>[s("#")]),_:1}),s("介绍")]),u]),t("div",b,[t("h3",g,[a(n,{to:"#基本使用"},{default:l(()=>[s("#")]),_:1}),s("基本使用")]),a(c,null,{default:l(()=>[v]),_:1})]),t("div",f,[t("h3",y,[a(n,{to:"#局部吸顶"},{default:l(()=>[s("#")]),_:1}),s("局部吸顶")]),a(c,null,{default:l(()=>[k]),_:1})]),x,t("div",N,[t("h3",V,[a(n,{to:"#属性"},{default:l(()=>[s("#")]),_:1}),s("属性")]),$]),t("div",w,[t("h3",z,[a(n,{to:"#方法"},{default:l(()=>[s("#")]),_:1}),s("方法")]),B]),t("div",C,[t("h3",P,[a(n,{to:"#事件"},{default:l(()=>[s("#")]),_:1}),s("事件")]),S]),t("div",T,[t("h3",q,[a(n,{to:"#插槽"},{default:l(()=>[s("#")]),_:1}),s("插槽")]),A])])}const K=o(r,[["render",E]]);export{K as default};
