import{_ as l,p as c,f as p,h as d,M as s,q as o,S as a,P as t,aq as r}from"./vue-router-d6817537.js";const i={components:{}},h={class:"varlet-site-doc"},_=s("h1",null,"浏览器适配",-1),u={class:"card"},m={id:"介绍"},j=s("p",null,[t("组件库提供移动端和桌面端适配方案， 移动端使用 "),s("code",null,"postcss-px-to-viewport"),t(" 方案进行适配， 桌面端使用 "),s("code",null,"@varlet/touch-emulator"),t(" 方案进行适配。")],-1),v={class:"card"},x={id:"移动端适配"},f=r("<p>组件库设计基于 <code>375px</code> 宽度设计稿，推荐使用 postcss 插件将 <code>px</code> 单位转换成 <code>vw</code> 单位从而实现移动端适配。 在 <code>Webpack/Vite</code> 项目根路径下创建 <code>postcss.config.js</code> 并做如下配置之后 <code>375px -&gt; 100vw</code>。</p>",1),g=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," npm"),t(`
...
`)])],-1);function C($,B,D,q,P,S){const e=c("router-link"),n=c("var-site-code-example");return p(),d("div",h,[_,s("div",u,[s("h3",m,[o(e,{to:"#介绍"},{default:a(()=>[t("#")]),_:1}),t("介绍")]),j]),s("div",v,[s("h3",x,[o(e,{to:"#移动端适配"},{default:a(()=>[t("#")]),_:1}),t("移动端适配")]),f,o(n,{"playground-ignore":""},{default:a(()=>[g]),_:1}),o(n,{"playground-ignore":""},{default:a(()=>[b]),_:1})]),s("div",w,[s("h3",y,[o(e,{to:"#桌面端适配"},{default:a(()=>[t("#")]),_:1}),t("桌面端适配")]),k,o(n,{"playground-ignore":""},{default:a(()=>[N]),_:1}),o(n,{"playground-ignore":""},{default:a(()=>[V]),_:1})])])}const W=l(i,[["render",C]]);export{W as default};
