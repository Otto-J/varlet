...
`)])],-1);function b(v,f,k,y,T,x){const l=o("var-site-code-example");return c(),r("div",p,[i,d,s("div",m,[u,e(l,{"playground-ignore":""},{default:n(()=>[j]),_:1}),_,e(l,{"playground-ignore":""},{default:n(()=>[g]),_:1})])])}const S=t(h,[["render",b]]);export{S as default};
