import{_ as c,p as e,f as p,h as r,M as a,q as n,S as t,P as s,aq as h}from"./vue-router.esm-bundler-6a15ebdc.js";const o={components:{}},d={class:"varlet-site-doc"},j=a("h1",null,"Floating Action Button",-1),i=a("div",{class:"card"},[a("h3",null,"Intro"),a("p",null,"Floating action button component for context menu.")],-1),g={class:"card"},m=a("h3",null,"Theme Color Action Buttons",-1),v=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
...
`),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
  `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-select"),s(),a("span",{class:"hljs-attr"},":hint"),s("="),a("span",{class:"hljs-string"},'"false"'),s(),a("span",{class:"hljs-attr"},"v-model"),s("="),a("span",{class:"hljs-string"},'"type"'),s(">")]),s(`
    ...
    `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-option"),s(),a("span",{class:"hljs-attr"},"label"),s("="),a("span",{class:"hljs-string"},'"danger"'),s(),a("span",{class:"hljs-attr"},"value"),s("="),a("span",{class:"hljs-string"},'"danger"'),s("/>")]),s(`
...
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),u={class:"card"},f=a("h3",null,"Trigger Position",-1),b=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
`),a("span",{class:"hljs-keyword"},"import"),s(" { ref } "),a("span",{class:"hljs-keyword"},"from"),s(),a("span",{class:"hljs-string"},"'vue'"),s(`
...
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),_={class:"card"},y=a("h3",null,"Trigger Mode",-1),k=a("p",null,"The contents of the menu are the default slots.",-1),w=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
`),a("span",{class:"hljs-keyword"},"import"),s(" { ref } "),a("span",{class:"hljs-keyword"},"from"),s(),a("span",{class:"hljs-string"},"'vue'"),s(`
...
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),x={class:"card"},S=a("h3",null,"Action Menu Pop Up Direction",-1),T=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
`),a("span",{class:"hljs-keyword"},"import"),s(" { ref } "),a("span",{class:"hljs-keyword"},"from"),s(),a("span",{class:"hljs-string"},"'vue'"),s(`
...
`),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
  ...
  `),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-fab"),s(">")]),s(`
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),A={class:"card"},z=a("h3",null,"Custom Triggers",-1),N=a("p",null,[s("Two-way binding via "),a("code",null,"v-model:active"),s(" controls whether the action menu is expanded and closed.")],-1),P=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
...
`)])],-1),B={class:"card"},V=a("h3",null,"Animation On Display",-1),D=a("p",null,[s("Through the "),a("code",null,"activator"),s(" slot, customize the trigger.")],-1),C=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
`),a("span",{class:"hljs-keyword"},"import"),s(" { ref, computed } "),a("span",{class:"hljs-keyword"},"from"),s(),a("span",{class:"hljs-string"},"'vue'"),s(`
...
`)]),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"style"),s(">")]),s(`
`)])],-1),F=h('<h2>API</h2><div class="card"><h3>Props</h3><h4>Fab Props</h4><table><thead><tr><th>Prop</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td><code>v-model:active</code></td><td>Trigger activity state</td><td><em>boolean</em></td><td><code>false</code></td></tr><tr><td><code>type</code></td><td>Same as the <code>Button</code> component, optional value is <code>default</code> <code>primary</code> <code>info</code> <code>success</code> <code>warning</code> <code>danger</code></td><td><em>string</em></td><td><code>primary</code></td></tr><tr><td><code>color</code></td><td>Background color</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>text-color</code></td><td>Text color</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>icon</code></td><td>Same as <code>Icon</code> component, icon name</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>icon-size</code></td><td>Same as <code>Icon</code> component, icon size</td><td><em>string | number</em></td><td><code>24px</code></td></tr><tr><td><code>trigger</code></td><td>Trigger mode; optional value is <code>click</code> <code>hover</code></td><td><em>string</em></td><td><code>click</code></td></tr><tr><td><code>direction</code></td><td>Action menu pop up direction; optional value is <code>top</code> <code>right</code> <code>bottom</code> <code>left</code></td><td><em>string</em></td><td><code>top</code></td></tr><tr><td><code>position</code></td><td>Trigger position; optional value is <code>left-top</code> <code>right-top</code> <code>right-bottom</code> <code>left-bottom</code></td><td><em>string</em></td><td><code>right-bottom</code></td></tr></tbody></table></div><div class="card"><h3>Slots</h3><h4>Fab Slots</h4><table><thead><tr><th>Name</th><th>Description</th><th>SlotProps</th></tr></thead><tbody><tr><td><code>default</code></td><td>Menu content</td><td><code>-</code></td></tr><tr><td><code>activator</code></td><td>Trigger</td><td><code>-</code></td></tr></tbody></table></div><div class="card"><h3>Style Variables</h3><p>Here are the CSS variables used by the component, Styles can be customized using <a href="#/en-US/style-provider">StyleProvider</a>.</p><h4>Fab Variables</h4><table><thead><tr><th>Variable</th><th>Default</th></tr></thead><tbody><tr><td><code>--fab-padding</code></td><td><code>10px</code></td></tr><tr><td><code>--fab-button-margin</code></td><td><code>6px</code></td></tr><tr><td><code>--fab-z-index</code></td><td><code>1</code></td></tr><tr><td><code>--fab-button-size</code></td><td><code>56px</code></td></tr><tr><td><code>--fab-button-item-size</code></td><td><code>40px</code></td></tr><tr><td><code>--fab-vertical-spacing</code></td><td><code>80px</code></td></tr><tr><td><code>--fab-horizontal-spacing</code></td><td><code>32px</code></td></tr><tr><td><code>--fab-transition-standard-easing</code></td><td><code>cubic-bezier(0.4, 0, 0.2, 1)</code></td></tr><tr><td><code>--fab-transition-decelerated-easing</code></td><td><code>cubic-bezier(0, 0, 0.2, 1)</code></td></tr><tr><td><code>--fab-transition-accelerated-easing</code></td><td><code>cubic-bezier(0.4, 0, 1, 1)</code></td></tr></tbody></table></div>',4);function I(M,$,U,q,E,H){const l=e("var-site-code-example");return p(),r("div",d,[j,i,a("div",g,[m,n(l,null,{default:t(()=>[v]),_:1})]),a("div",u,[f,n(l,null,{default:t(()=>[b]),_:1})]),a("div",_,[y,k,n(l,null,{default:t(()=>[w]),_:1})]),a("div",x,[S,n(l,null,{default:t(()=>[T]),_:1})]),a("div",A,[z,N,n(l,null,{default:t(()=>[P]),_:1})]),a("div",B,[V,D,n(l,null,{default:t(()=>[C]),_:1})]),F])}const G=c(o,[["render",I]]);export{G as default};
