...
`)])],-1),N=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// nuxt.config.ts"),n(`
...
`)])],-1),w={class:"card"},V={id:"示例仓库"},b=s("p",null,[s("a",{href:"https://github.com/varletjs/varlet-install-example/tree/main/nuxt"},"varlet-install-example/nuxt")],-1);function I(C,R,$,B,D,U){const e=o("router-link"),l=o("var-site-code-example");return p(),r("div",i,[d,s("div",h,[s("h3",_,[t(e,{to:"#介绍"},{default:a(()=>[n("#")]),_:1}),n("介绍")]),m]),s("div",j,[s("h3",f,[t(e,{to:"#创建 Nuxt 项目"},{default:a(()=>[n("#")]),_:1}),n("创建 Nuxt 项目")]),v]),s("div",g,[s("h3",x,[t(e,{to:"#按需引入"},{default:a(()=>[n("#")]),_:1}),n("按需引入")]),k,t(l,{"playground-ignore":""},{default:a(()=>[y]),_:1}),t(l,null,{default:a(()=>[N]),_:1})]),s("div",w,[s("h3",V,[t(e,{to:"#示例仓库"},{default:a(()=>[n("#")]),_:1}),n("示例仓库")]),b])])}const S=c(u,[["render",I]]);export{S as default};
