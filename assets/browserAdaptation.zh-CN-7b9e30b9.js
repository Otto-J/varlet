...
`)])],-1);function C($,B,D,P,T,W){const e=l("router-link"),n=l("var-site-code-example");return p(),d("div",h,[_,s("div",u,[s("h3",m,[o(e,{to:"#介绍"},{default:a(()=>[t("#")]),_:1}),t("介绍")]),j]),s("div",v,[s("h3",x,[o(e,{to:"#移动端适配"},{default:a(()=>[t("#")]),_:1}),t("移动端适配")]),g,o(n,{"playground-ignore":""},{default:a(()=>[f]),_:1}),o(n,{"playground-ignore":""},{default:a(()=>[b]),_:1})]),s("div",w,[s("h3",y,[o(e,{to:"#桌面端适配"},{default:a(()=>[t("#")]),_:1}),t("桌面端适配")]),k,o(n,{"playground-ignore":""},{default:a(()=>[N]),_:1}),o(n,{"playground-ignore":""},{default:a(()=>[V]),_:1})])])}const A=c(i,[["render",C]]);export{A as default};
