import{_ as o,b as r,e as p,l as d,m as a,p as t,w as l,P as s,Z as c}from"./index-265bf7c3.js";const h={components:{}},j={class:"varlet-site-doc"},i=a("h1",null,"结果",-1),g={class:"card"},u={id:"介绍"},m=a("p",null,"用于向用户展示结果。",-1),f={class:"card"},v={id:"基本使用"},_=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),b={class:"card"},y={id:"类型"},k=c("<p>结果类型，可选值为 <code>info</code>，<code>success</code>，<code>warning</code>，<code>error</code>，<code>question</code>，<code>empty</code>。</p>",1),w=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
